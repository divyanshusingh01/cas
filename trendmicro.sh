CTIVATIONURL='dsm://agents.deepsecurity.trendmicro.com:443/'
...
curl -H "Agent-Version-Control: on" -L $MANAGERURL/software/agent/${runningPlatform}${majorVersion}/${archType}/$package?tenantID=74534 -o /tmp/$package $CURLOPTIONS
...
/opt/ds_agent/dsa_control -a $ACTIVATIONURL "tenantID:AC5FA8FD-00BE-8DC1-06FC-6035ED15EEBA" "token:02082571-92BE-DE06-07EF-9FE0AA346D81" "policyid:1882" "groupid:114626"
# /opt/ds_agent/dsa_control -a dsm://agents.deepsecurity.trendmicro.com:443/ "tenantID:AC5FA8FD-00BE-8DC1-06FC-6035ED15EEBA" "token:02082571-92BE-DE06-07EF-9FE0AA346D81" "policyid:1882" "groupid:114626"
